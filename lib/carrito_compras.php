...
if(isset($_POST['id'])){  
  ...
  $stock = $_POST['stock'];
  $mi_carrito []= array('id'=>$id, 'imagen'=>$imagen, 'nombre'=>$nombre, 'precio'=>$precio, 'cantidad'=> $cantidad, 'stock'=>$stock);  
}
...
if(isset($_SESSION['carrito'])){
 ...
 //Verifica si es el producto es repetido
    ...
    if($pos != -1){
      ...
      $mi_carrito[$pos] = array ('id'=>$id, 'imagen'=>$imagen, 'nombre'=>$nombre, 'precio'=>$precio, 'cantidad'=> $cuanto, 'stock'=>$stock);
